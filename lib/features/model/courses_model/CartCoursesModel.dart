class MyCartCoursesModel {
  ...
  final bool status;
  final List<MyCartCoursesDataModel> data;
  final String msg;

  factory MyCartCoursesModel.fromJson(Map<String, dynamic> json) => MyCartCoursesModel(
    status: json["status"],
    data: List<MyCartCoursesDataModel>.from(json["data"].map((x) => MyCartCoursesDataModel.fromJson(x))),
    msg: json["msg"],
  );
...
class MyCartCoursesDataModel {
  MyCartCoursesDataModel({
  ...
  factory MyCartCoursesDataModel.fromJson(Map<String, dynamic> json) => MyCartCoursesDataModel(
    cartId: json["cart_id"],
